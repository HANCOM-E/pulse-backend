...
public class ReportSummaryGenerator {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            아래 소감들만 근거로 행사 전체에 대한 한국어 요약을 3~5문장으로 작성해.
            소감에 없는 내용을 지어내지 말고, 전반적인 만족도·자주 나온 의견·개선점을 균형 있게 담아.
            """;
    ...
    public String summarize(FeedbackSnapshot snapshot) {
        ...
        ChatRequest request = new ChatRequest(
                model, List.of(new Message("system", SYSTEM_PROMPT), new Message("user", buildUserPrompt(feedbacks))));
